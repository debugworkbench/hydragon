...
declare module _ {
    ...
    **/
    ...
    interface LoDashImplicitArrayWrapper<T> {
        ...
        object(
            values?: List<any>
        ): _.LoDashImplicitObjectWrapper<Dictionary<any>>;
    }
    ...
    interface LoDashExplicitArrayWrapper<T> {
        ...
        object(
            values?: List<any>
        ): _.LoDashExplicitObjectWrapper<Dictionary<any>>;
    }
    ...
    interface LoDashImplicitWrapperBase<T, TWrapper> {
         ...
         * @see _.noConflict
         */
        noConflict(): LoDashImplicitWrapperBase<T, TWrapper>;
    }
    ...
    interface LoDashImplicitObjectWrapper<T> {
         ...
         * @see _.runInContext
         */
        runInContext(): LoDashImplicitObjectWrapper<T>;
    }
